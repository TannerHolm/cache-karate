...
define('LOGOUT_URL', 'http://cachekarate.com');
...
<div class="container">
  ...
  <form class="form-signin" method="post">
    ...
    <!-- <input type="text" class="form-control" name="access_login" placeholder="Username" required="" autofocus=""> -->
    <input type="password" name="access_password" class="form-control" placeholder="Password" required="">
        <font color="white"><?php echo $error_msg; ?></font><br />
